package _12_Stream.finalOperator.collectors.patitioningBy;
...
public class StreamPatitioningBy {
	public static void main(String[] args) {
		...
		System.out.println("남자학생 수: " + stuNumBySex.get(true));
		System.out.println("여자학생 수: " + stuNumBySex.get(false));
...
//		for(Student s: failedMaleStu) System.out.println(s);
		...
		Stream<Student> stu = failedMaleStu.stream();
